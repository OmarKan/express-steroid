 ...
 */
function extractFromSchema(model, requiredAll, checkRequired, ignoredFields, sources){
    //Get the fields.
    let fields          = getSchemaFields(model, ignoredFields || this.prefs.extractor.ignoredFields);
