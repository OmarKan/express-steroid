...
/**
 * Creates an "inArray" query. Where the dbFieldName is one of the values of param array.
 * @param {Array}               param           Array for comparison.
 * @param {String}              dbFieldName     Name of the field in the database.
 * @returns {Object}                            $in query.
 */
function inArray(param, dbFieldName){
    let query = {};
    query[dbFieldName] = {$in: param};
